            ...
            <div class="contain">
                ...
                <!-- <div class="item-container">
                    ...
                    <div class="item-description">
                        <p>Plate</p>
                        <button class="restock-button">Restock Plate Number</button>
                    </div>
                ...
                <div class="row">
                    <div class="col-7">
                        <div class="card text-bg-light mb-3">
                            <div class="card-body">
                                <h2 class="card-title fs-bold">T-shirt Printing</h2>
                                <div class="item-description">
                ...
                <?php
                    ...
                    if ($result && $result->num_rows > 0) { 
                        ...
                        $mugQuantity = $row['mugQuantity'];
                    }
                    $conn->close();
                ?>

                <div class="col-5">
                    <div class="card text-bg-light mb-3 position-relative pb-4">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <div>
                                <h2 class="card-title fs-bold">Mug Printing</h2>
                            </div>
                            <div>
                                <table>
                                    <tr class="fs-4">
                                        <td class="fs-4 text-dark">Quantity:</td>
                                        <td>
                                        <input type="number" id="mugQuantityInput" class="editable fs-4 form-control" value="<?php echo $mugQuantity; ?>" />
                                        </td>
                                    </tr>
                                </table><br>
                                <strong><p><i>Note:</strong> By Clicking the Quantity above above allows you to edit for mugs stocks.</i></p>
                            </div>
                        </div>
                    </div>
                </div>            
